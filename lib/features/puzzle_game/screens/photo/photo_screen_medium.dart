...
import 'package:autism_empowering/features/puzzle_game/widgets/photo_screen/image_viewer.dart';
import 'package:autism_empowering/features/puzzle_game/widgets/photo_screen/pick_image_button.dart';
import 'package:autism_empowering/features/puzzle_game/widgets/solo_screen/countdown_overlay.dart';
import 'package:autism_empowering/features/puzzle_game/widgets/solo_screen/solo_screen_export.dart';
...
class _PhotoScreenMediumState extends ConsumerState<PhotoScreenMedium> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        Scaffold(
          backgroundColor: Palette.blue.withOpacity(0.3),
